...
<div class=" index-content">
  <div class="pc-sn content_bar row">
    ...
    <a href="#">
      <dl class="col-md-2">
        <dt class="fourth"><img src="<?=Yii::$app->params['img_url']?>index/classification-4.png" width="150%" style="margin-top: 16px;"></dt>
        <dd>
          <h2>大英语</h2>
          <p>大英语，岂止英语</p>
        </dd>
  ...
  <div class="pc-sn teacher-content">
    ...
    <div id='container'>
      <div class="swiper-slide" class="teacher-0"><img src="<?=Yii::$app->params['img_url']?>index/teacher-5.jpg"><h4>窦昕</h4><p>大语文创始人</p></div>
      <div class="swiper-slide" class="teacher-1"><img src="<?=Yii::$app->params['img_url']?>index/teacher-2.jpg"><h4>窦昕</h4><p>大语文创始人</p></div>
      <div class="swiper-slide" class="teacher-2"><img src="<?=Yii::$app->params['img_url']?>index/teacher-3.jpg"><h4>窦昕</h4><p>大语文创始人</p></div>
      <div class="swiper-slide" class="teacher-3"><img src="<?=Yii::$app->params['img_url']?>index/teacher-4.jpg" ><h4>窦昕</h4><p>大语文创始人</p></div>
      <div class="swiper-slide" class="teacher-4"><img src="<?=Yii::$app->params['img_url']?>index/teacher-5.jpg" ><h4>窦昕</h4><p>大语文创始人</p></div>
      <div class="swiper-slide" class="teacher-5"><img src="<?=Yii::$app->params['img_url']?>index/teacher-5.jpg"><h4>窦昕</h4><p>大语文创始人</p></div>
      <div class="swiper-slide" class="teacher-6"><img src="<?=Yii::$app->params['img_url']?>index/teacher-2.jpg"><h4>窦昕</h4><p>大语文创始人</p></div>
      <div class="swiper-slide" class="teacher-7"><img src="<?=Yii::$app->params['img_url']?>index/teacher-3.jpg"><h4>窦昕</h4><p>大语文创始人</p></div>
